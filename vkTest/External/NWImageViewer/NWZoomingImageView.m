...
{
//    [_photoImageView setImageWithURL:url placeholderImage:placeholder completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
//         [self setImage:image]; // =(
...
- (void)handleSingleTap:(CGPoint)touchPoint {
    if ([self.zoomingDelegate respondsToSelector:@selector(closeImageView)]) {
        [self.zoomingDelegate performSelector:@selector(closeImageView)];
    }
}
